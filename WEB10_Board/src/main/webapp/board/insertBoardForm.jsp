...
<div id="main_container">
	...
	<div class="board">
		<form class="insertBoard" method="post" name="insertBoard" action="board.do">
			...
			<div class="field"><label>비밀번호</label><input style="flex:2" type="password" name="pass" />
				<div style="flex:2; margin-left:20px;">게시물 수정/삭제 시 필요</div>
			</div>
			...
			<div class="field"><label>내용</label><textarea name="content" rows="10" cols="110"></textarea></div>
			<div class="field">
