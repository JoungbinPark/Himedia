		...
		<form name="productWriteFrm" method="post"
			...
			<div class="field">
				<label>원가</label> <input type="text" name="price1"
					style="margin-right: 20px;" value="${productVO.price1}" onKeyup="cals();" /> <label>판매가</label>
				<input type="text" name="price2" style="margin-right: 20px;" value="${productVO.price2}"
					onKeyup="cals();" /> <label>마진</label> <input type="text"
					name="price3" value="${productVO.price3}" readonly />
			</div>
			...
			<div class="field">
				<label>기존이미지</label><img src="product_images/${productVO.savefilename}" width="300">
			</div>
			<div class="btn">
