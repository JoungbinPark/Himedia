	...
	<form method="post" name="frm">
		<div class="tb">
			<div class="row">
				<div class="col" style="display: flex; align-items: center">
					...
					&nbsp;&nbsp;&nbsp; <input class="btn" type="button"
						name="btn_search" value="검색" onClick="go_search('adminOrderList')" />
					&nbsp;&nbsp;&nbsp;
				</div>
			</div>
			<div class="row">
			...
			<c:forEach items="${orderList}" var="orderVO">
				<div class="row">
					<div class="col" style="flex: 2">${orderVO.oseq}
					...
					<div class="col" style="flex: 4">${orderVO.address1}
						${orderVO.address2}</div>
