...
<style type="text/css">
.title{width:700px; height:80px; border:1px solid gray; margin:0 auto; text-align:center;}
.container{width:700px; margin:0 auto; border:1px solid gray; display:flex; justify-content:center; flex-direction:column;}
...
<%
	...
	// 이전달이나 다음달 버튼을 클릭하고 이동해온 경우는 null도 아니고 그 값으로 sYear와 sMonth를 교체해줘야 한다.
	...
	int lastDay = sDay.getActualMaximum(Calendar.DATE);	//현재달 말일 추출
...
<div class="container">
	...
	int k;
	for(k = 1; k<start_week; k++){		//첫칸부터 1일자 요일칸 전까지 빈칸으로 출력
