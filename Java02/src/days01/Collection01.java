...
public class Collection01 {
	...
	public static void main(String[] args) {
		...
		// 동적 배열의 객체 생성 초기값으로 크기를 지정할 수 있지만 통상 크기 지정 없이 사용 가능
		
		//데이터 추가
		v.add(10);	v.add(20);	v.add(30);
		a.add(10);	a.add(20);	a.add(30);
		
		//Vector와 ArrayList 저장은 int형이 아닌 Integer형 데이터(객체)가 저장된다.
		
		//ArrayList 안에 add 멤버 메서드가 존재하고 그 메서드를 통해 데이터를 저장
		//a.add("abc");
		//v.add("abc");
		// add 메서드의 매개변수는 Object 인 것을 예상할 수 있다. 
